#!E:\GIT\Python\100_Days_of_Code\Day21\venv\Scripts\python.exe
...
foodObject = food.Food((width,heigth)) 
snakeObject = snake.Snake((width,heigth), 3, initialCoord, stepSize, foodObject)
